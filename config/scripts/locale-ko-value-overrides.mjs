...
export const KO_VALUE_OVERRIDES = {
  ...
  'Review inactive workspaces before deleting their local files and Muster state.':
    '로컬 파일과 Muster 상태를 삭제하기 전에 비활성 워크스페이스를 확인하세요.',
  ...
  'Install the Muster skill so agents know to use the Muster CLI.':
    '에이전트가 Muster CLI를 사용하도록 Muster 스킬을 설치하세요.',
