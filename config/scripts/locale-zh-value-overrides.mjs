...
export const ZH_VALUE_OVERRIDES = {
  ...
  'Muster IDE': 'Muster IDE',
  'Muster first': 'Muster 优先',
  'Muster Mobile': 'Muster Mobile',
  'Muster logo': 'Muster 标志',
  'Enjoying Muster?': '喜欢 Muster 吗？',
  'Get to know Muster': '了解 Muster',
  'Expand Muster': '展开 Muster',
  'Support Muster': '支持 Muster',
  'Restarting Muster…': '正在重启 Muster…',
  'Muster Attribution': 'Muster 归因',
  'Show Muster Mobile Button': '显示 Muster Mobile 按钮',
  ...
  "Give agents direct access to Muster's browser so they can test pages, capture screenshots, and act on what they see.":
    '让代理直接访问 Muster 的浏览器，以便测试页面、捕获屏幕截图并根据所见内容执行操作。',
  ...
  'from Muster. It is still on your disk.': '来自 Muster。它仍保留在您的磁盘上。',
