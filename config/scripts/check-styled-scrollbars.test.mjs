...
describe('check-styled-scrollbars', () => {
  it('reports renderer vertical scroll containers without a Muster scrollbar style', () => {
  ...
  it('does not accept nonexistent scrollbar classes as Muster scrollbar styles', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
  ...
  it('reports inline vertical overflow without a Muster scrollbar class', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
  ...
  it('accepts inline vertical overflow with a stable Muster scrollbar class', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
  ...
  it('reports logical inline style spreads without a Muster scrollbar class', () => {
    const reports = reportUnstyledScrollbars(
      'Example.tsx',
