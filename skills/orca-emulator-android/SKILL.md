...
# Muster Emulator (Android)

This file is a discovery stub, not the usage guide. The full, version-matched Muster Android
...
Engage Muster whenever you drive an adb-connected Android emulator or device from inside the
Muster app: listing/booting AVDs, taps, swipes, typing, hardware buttons (including Back and
