...
export const troubleshootCommonIssues: TroubleshootSection[] = [
  ...
  },
  {
    ...
    steps: [
      'macOS: System Settings → Network → Firewall — allow Muster.',
      'Windows: Defender Firewall → Allow app — enable Muster for Private networks.',
  ...
  },
  {
    ...
    steps: [
      'Muster must be open on your desktop to accept connections.',
      'Try restarting Muster — the companion server starts on launch.',
