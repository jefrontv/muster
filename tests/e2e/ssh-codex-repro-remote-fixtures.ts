...
await write('If Muster leaves wide gray rectangles here, they are stale remote-PTY render artifacts.\\r\\n')
...
await write('Tip: deterministic fixture for Muster SSH Codex display artifacts.\\r\\n\\r\\n')
