...
type ImageViewerPopupProps = {
  ...
  /** Sits on the zoom surface: an `<img>`, or whatever stands in while there is no image yet. */
  children: ReactNode
  /** Controls placed before the close button — pager arrows, counters. */
  headerActions?: ReactNode
  /**
   * Radix's modal default returns focus to a `DialogTrigger`. A popup opened programmatically has
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <div className="flex shrink-0 items-center justify-between gap-3 border-b border-border/60 bg-background/95 px-3 py-2">
