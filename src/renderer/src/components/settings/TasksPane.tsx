...
const TASK_PROVIDER_OPTIONS: readonly {
  ...
  },
  {
    id: 'activecollab',
    get label() {
      return translate('auto.components.settings.TasksPane.activecollabLabel', 'ActiveCollab')
    },
    get description() {
      return translate(
        'auto.components.settings.TasksPane.activecollabDescription',
        'Show ActiveCollab in the Tasks source picker and sidebar shortcuts.'
      )
    },
    Icon: ({ className }) => <ActiveCollabIcon className={className} />
  }
]
