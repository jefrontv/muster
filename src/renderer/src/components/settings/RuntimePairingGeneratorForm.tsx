      ...
      {webClientUrl ? (
        ...
        <UnavailableUrlRow
          ...
          description={translate(
            ...
            'Browser link unavailable in this build. The pairing URL still works for Muster clients.'
          )}
        />
      ) : null}
      ...
      {runtimePairingUrl ? (
        <GeneratedUrlRow
          label={translate(
            ...
            'Pair another Muster client'
          )}
          description={translate(
            'auto.components.settings.RuntimePairingUrlGenerator.849825e829',
            'Paste this pairing URL into another Muster client.'
          )}
