...
// Why only ActiveCollab: this fork's task workflow runs on ActiveCollab; Linear/Jira stay
// functional for existing data but are not offered for setup here.
import {
  ActiveCollabIntegrationCard,
  ActiveCollabMcpInstallCard
...
export function IntegrationsPane(): React.JSX.Element {
  ...
  return (
    <div className="space-y-5">
      {/* Task providers lead: this fork's daily loop is ActiveCollab tasks; review hosts are setup-once. */}
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'Connect issue trackers Muster can use to browse tasks and start workspaces with linked context.'
            )}
          </p>
        </div>
        ...
        <div className="space-y-1">
          ...
          <p className="text-xs text-muted-foreground">
            {translate(
              ...
              'Connect the source hosts Muster can use for pull requests, merge requests, checks, and review status.'
            )}
          </p>
        </div>
        <div className="space-y-3">
