...
const ORCA_ANDROID_APK_URL =
  'https://github.com/jefrontv/muster/releases/download/mobile-android-v0.0.32/app-release.apk'
    ...
    <div className="space-y-4">
        ...
        <div className="space-y-2 text-xs text-muted-foreground">
          <p>
            {translate(
              ...
              'Install Muster Mobile from the'
            )}{' '}
            <button
              type="button"
      ...
      <SearchableSetting
        title={translate(
          ...
          'Show Muster Mobile Button'
        )}
        description={translate(
          'auto.components.settings.MobileSettingsPane.682293cadf',
          'Show the Muster Mobile button at the top of the left sidebar.'
        )}
      ...
      >
        ...
        <SettingsSwitchRow
          ...
          description={translate(
            ...
            'Show the Muster Mobile shortcut in the sidebar.'
          )}
