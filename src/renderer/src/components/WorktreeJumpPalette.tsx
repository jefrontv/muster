...
export default function WorktreeJumpPalette(): React.JSX.Element | null {
  ...
  const handleCreateWorktree = useCallback(() => {
    ...
    const openComposer = (data: NewWorkspaceComposerModalPayload): void => {
      prefetchCreateWorkspaceBaseForComposer(data.initialRepoId)
      closeModal()
      recordFeatureInteraction('cmd-j-create-workspace')
    ...
    if (ghNumber !== null) {
      ...
      void lookupGitHubWorkItemForSource({
        ...
        .then((item) => {
          ...
          const data: NewWorkspaceComposerModalPayload = { initialRepoId: repoForLookup.id }
          if (item) {
  ...
  const emptyState = (() => {
    ...
    return {
      ...
      subtitle: translate(
        ...
        'Create a worktree or open a tab in Muster to get started.'
      )
    }
  })()
