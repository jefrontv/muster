...
describe('MobilePageToolbar', () => {
  it('labels the sidebar toggle explicitly when Muster Mobile is visible in the sidebar', () => {
    ...
    expect(html).not.toContain('Remove Muster Mobile')
  })

  it('labels the restore action explicitly when Muster Mobile is hidden from the sidebar', () => {
    const html = renderToStaticMarkup(
      <MobilePageToolbar
