...
export const SOURCE_CONTROL_ACTION_VARIABLE_INFO = {
  basePrompt: {
    description:
      'Muster’s built-in prompt for this action, including the context Muster knows how to gather safely.',
    example:
  ...
  firstPrompt: {
    description: 'The first user request that created the Muster workspace.',
    example: 'Fix CI and commit the result'
  },
  assistantMessage: {
    description: 'The initial agent response, when Muster has one available.',
