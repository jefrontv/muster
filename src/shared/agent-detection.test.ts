...
describe('Pi-compatible title detection', () => {
  ...
  it.each([
    ...
    ['\u280b OMP', 'pi', '\u280b Pi'],
    [
      'lucky-echidna | \u283c π - Diagnose Muster terminal title flicker - test',
      'omp',
      '\u280b OMP'
    ],
...
describe('Cursor agent title identity', () => {
  ...
  it('accepts every label Muster synthesizes for Cursor', () => {
  ...
  ])('accepts the native or Muster-synthesized Cursor title %j', (title) => {
  ...
  it.each([
    ...
    'Terminal Cursor and Muster slows down',
    'cursor-agent',
    'cursor.exe',
    '~/cursor-rules',
    '',
