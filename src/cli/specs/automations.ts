...
export const AUTOMATION_COMMAND_SPECS: CommandSpec[] = [
  {
    ...
    summary: 'List scheduled Muster automations',
  ...
  },
  {
    ...
    summary: 'Show one Muster automation',
  ...
  },
  {
    ...
    summary: 'Create a scheduled Muster automation',
    usage:
    ...
    notes: [
      ...
      'When --repo is omitted, the CLI uses the enclosing Muster worktree when one can be resolved from cwd.',
  ...
  },
  {
    ...
    summary: 'Edit a Muster automation',
  ...
  },
  {
    ...
    destructive: true,
    summary: 'Remove a Muster automation and its run history',
  ...
  },
  {
    ...
    summary: 'Run a Muster automation now',
