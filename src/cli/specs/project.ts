...
export const PROJECT_COMMAND_SPECS: CommandSpec[] = [
  {
    path: ['project', 'list'],
    summary: 'List durable projects known to Muster',
  ...
  },
  {
    ...
    examples: [
      'orca project setups',
      'orca project setups --project github:jefrontv/muster',
  ...
  },
  {
    ...
    examples: [
      'orca project setup-existing-folder --project github:jefrontv/muster --host local --path ~/orca',
      'orca project setup-existing-folder --project github:jefrontv/muster --host runtime:gpu --path /home/me/orca --kind git --json'
    ]
  },
  {
    ...
    examples: [
      'orca project setup-clone --project github:jefrontv/muster --host local --url https://github.com/jefrontv/muster.git --destination ~/src',
      'orca project setup-clone --project github:jefrontv/muster --host runtime:gpu --url https://github.com/jefrontv/muster.git --destination /srv --json'
    ]
  },
  {
    ...
    notes: [
      ...
      'Use setup-existing-folder when Muster should import and manage an actual checkout path now.'
    ],
    examples: [
      'orca project setup-create --project github:jefrontv/muster --host runtime:gpu --state setting-up --method provisioned --json'
    ]
  },
  {
    ...
    examples: [
      'orca project setup-update --setup github:jefrontv/muster::gpu --display-name "GPU VM"',
      'orca project setup-update --setup github:jefrontv/muster::gpu --path /srv/orca --state ready --json'
    ]
  },
  {
    ...
    examples: ['orca project setup-delete --setup github:jefrontv/muster::gpu --json']
  }
]
