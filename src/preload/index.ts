...
const api = {
  ...
  planAnnotation: {
    ...
    onQueued: (callback) => {
      ...
      ipcRenderer.on('planAnnotation:queued', listener)
      return () => ipcRenderer.removeListener('planAnnotation:queued', listener)
    },
    onResolved: (callback) => {
  ...
  activecollab: {
    ...
    createSubtask: (args) => ipcRenderer.invoke('activecollab:createSubtask', args),
    updateSubtask: (args) => ipcRenderer.invoke('activecollab:updateSubtask', args),
    completeSubtask: (args) => ipcRenderer.invoke('activecollab:completeSubtask', args),
    reopenSubtask: (args) => ipcRenderer.invoke('activecollab:reopenSubtask', args),
    updateComment: (args) => ipcRenderer.invoke('activecollab:updateComment', args),
    deleteComment: (args) => ipcRenderer.invoke('activecollab:deleteComment', args),
    setTaskSubscription: (args) => ipcRenderer.invoke('activecollab:setTaskSubscription', args),
    ...
    listUpdates: (args) => ipcRenderer.invoke('activecollab:listUpdates', args),
